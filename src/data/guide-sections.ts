// Guide registry data — the single source of truth for which guides exist,
// their slugs, sections, status, and metadata. Extracted from guides.ts so
// the data constant doesn't bury the routing/link logic. Consume via the
// public API in `./guides` (re-exports SECTIONS plus helpers), not directly.
...
export const SECTIONS: Section[] = [
  {
    num: '0',
    title: 'About',
    blurb: 'What mcp-rune is and the thinking behind it — start here if you want the why before the how.',
    guides: [
      {
        slug: 'philosophy',
        label: 'Philosophy',
        status: 'live',
        file: '00-about/philosophy.md',
        blurb: 'The worldview behind every API decision — the rune metaphor, the two-tier architecture, and the seven invariants the framework is held to.',
        read: '6 min',
        tags: ['concepts'],
        icon: 'brain',
      },
      {
        ...
        label: 'Why mcp-rune?',
        status: 'live',
        file: '00-about/why-mcp-rune.md',
        blurb: 'Why mcp-rune exists and how it compares to protocol wrappers, API converters, and FastMCP — plus when it is not the right fit.',
        read: '5 min',
        tags: ['concepts'],
        icon: 'scope',
      },
  ...
  },
  {
    ...
    guides: [
      ...
      },
      {
        ...
        blurb: 'The synchronous, per-model-bound interface: model + resolveDerivedFields. Kinds are shared vocabulary read beside it. No I/O.',
        read: '5 min',
        tags: ['architecture', 'core'],
        icon: 'schema',
      },
      {
        ...
        blurb: 'The per-model-bound, per-request interface. extractEdges, buildEmbeddingText, walkHops. The substrate Part III\'s analysis tools call into.',
        read: '5 min',
    ...
    guides: [
      {
        ...
        blurb: 'Part 2 of the Quickstart: bring up pgvector and walk the nine summary strategies (plus path and record-semantic queries) end to end against the bookshelf-graph fixtures.',
        read: '12 min',
